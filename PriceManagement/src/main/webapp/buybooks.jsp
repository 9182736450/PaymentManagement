...
<head>
    ...
    <style>
    @import url('https://font.googleapis.com/css2?family=poppins:wght@100;300;400;500;600&display=swap');
*{
    ...
    <div class="container">
        ...
        <div class="col">
            ...
            <div class="inputBox">
                ...
                <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRmL65ZcTMbU0wPZetQczGND4GTpN43XbWDCQ&usqp=CAU" alt="">
            </div>
            <div class="inputBox">
                <span>name of card :</span>
                <input type="text" name="nameofcard" placeholder="mr. john deo">
            </div>
            <div class="inputBox">
                <span>credit/debit card number :</span>
                <input type="number" name="credit_debit_card" placeholder="1111-2222-3333-4444">
            </div>
            <div class="inputBox">
                <span>exp month :</span>
